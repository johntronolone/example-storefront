...
class CartDrawerEmptyMessage extends Component {
  static propTypes = {
    /**
  ...
  static defaultProps = {
    ...
    messageText: "Items added to the cart will appear here."
  };
...
export default withComponents(CartDrawerEmptyMessage);
