...
//import { addTypographyStyles, applyTheme, CustomPropTypes } from "components/CartDrawerItems/utils";
import addTypographyStyles from 'components/CartDrawerItems/utils/addTypographyStyles';
import applyTheme from 'components/CartDrawerItems/utils/applyTheme';
import CustomPropTypes from 'components/CartDrawerItems/utils/CustomPropTypes';
...
class CartDrawerItems extends Component {
  static propTypes = {
    /**
     * Cart data
     */
...
export default withComponents(CartDrawerItems);
