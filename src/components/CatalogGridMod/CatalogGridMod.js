...
import preventAccidentalDoubleClick from 'components/CartDrawerItems/utils/preventAccidentalDoubleClick';
...
class CatalogGridMod extends Component {
  static propTypes = {
    /**
...
export default withComponents(CatalogGridMod);
