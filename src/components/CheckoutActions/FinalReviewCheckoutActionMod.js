...
import applyTheme from "components/CheckoutActions/utils/applyTheme";
...
class FinalReviewCheckoutActionMod extends Component {
...
export default withComponents(FinalReviewCheckoutActionMod);
