...
//import { addTypographyStyles, CustomPropTypes, formatMoney } from "utils";
import addTypographyStyles from "components/CheckoutActions/utils/addTypographyStyles";
import CustomPropTypes from "components/CheckoutActions/utils/CustomPropTypes";
...
class PaymentsCheckoutActionMod extends Component {
  ...
  constructor(props) {
    ...
    console.log("selected payment method name: ");
    console.log({selectedPaymentMethodName});*/
...
export default withComponents(PaymentsCheckoutActionMod);
