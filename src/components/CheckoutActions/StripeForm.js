...
import withStripeElements from "components/CheckoutActions/utils/withStripeElements";
...
class StripeForm extends Component {
  ...
  componentDidMount = async () => {
    console.log("StripeFrom componentDidMount: ");
    console.log(this.props.stripe);
    console.log(this.props.stripeRef);
    //await new Promise(resolve => { setTimeout(resolve, 5000); }).then(() => {
    if (this.props.stripe) {
      this.props.stripeRef(this.props.stripe);
    } else {
      console.log("no stripe defined");
    }
    //});
  }
  ...
  componentDidUpdate = () => {
    console.log("StripeFrom componentDidUpdate: ");
    console.log(this.props.stripe);
    console.log(this.props.stripeRef);
    if (this.props.stripe) {
      this.props.stripeRef(this.props.stripe);
  ...
  render() {
    ...
    return (
      <Fragment>
        <AcceptedPaymentMethods>TODO: remove
