...
//import addTypographyStyles from "components/CheckoutSummary/utils/addTypographyStyles";
import addTypographyStyles from "components/CheckoutSummary/utils/addTypographyStyles";
import applyTheme from "components/CheckoutSummary/utils/applyTheme";
...
class CartSummary extends Component {
  static propTypes = {
    ...
    /**
     * The text for the "Discount" label text.
     */
    discountLabelText: PropTypes.string,
    /**
  ...
  renderDiscount() {
    ...
    const formatDiscount = formatMoney(displayDiscount); 
    return (
      <tr>
  ...
  render() {
    ...
    const discount = displayDiscount > 0 && this.renderDiscount();
